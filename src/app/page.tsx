...
export default function Hero() {
  return (
    <main className="h-[100dvh] md:h-screen bg-background text-foreground relative overflow-hidden flex flex-col">
        ...
        <div className="max-w-6xl w-full text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6">
            ...
            <Button
              ...
              size="lg"
              className="w-full sm:w-auto h-16 sm:h-14 px-6 sm:px-8 text-base sm:text-lg font-bold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
              style={{ background: "linear-gradient(135deg, #F06BF2 0%, #79F2E6 100%)" }}
            >
              <a href="/new-layout">
                🚀 Use WANKR
              </a>
      ...
      {/* Footer Section */}
      <footer className="flex-shrink-0 mb-4 py-0 md:py-8 px-4 md:px-6">
        <div className="max-w-6xl mx-auto flex justify-center">
          <a
            href="https://x.com/wankergyatt"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-foreground/70 hover:text-foreground transition-colors duration-200 mb-1 md:mb-0"
          >
